...
- Custom domain: CNAME `quiz` → `jarva77.github.io` στο DNS του Papaki (domain `jarvantage.com`).
...
- **Εκκρεμεί:** αλλαγή email επικοινωνίας απορρήτου (τώρα jarva77@gmail.com στο `PrivacyScreen.vue`) — ο χρήστης θα δώσει νέα διεύθυνση.
...
- Commits: αγγλικά, τελειώνουν με `Co-Authored-By: Claude Fable 5 <noreply@anthropic.com>`.
